...
from myEnv.stockDataReader import countPerDay, symbolCount, signalCount
...
class MuZeroConfig:
    def __init__(self):
        ...
        self.num_simulations = 60  # Number of future moves self-simulated
        ...
        self.batch_size = 32  # Number of parts of games to train on at each training step # by YAO, with batch_size increasing, it needs more memory
