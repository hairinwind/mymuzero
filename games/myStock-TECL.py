...
class MuZeroConfig:
    def __init__(self):
        ...
        self.max_moves = 3 # 1000  # Maximum number of moves if game is not finished before
        self.num_simulations = 3 # 200  # Number of future moves self-simulated
        ...
        self.training_steps = 5 # 10000  # Total number of training steps (ie weights update according to a batch)
